...
def main():
    print("=" * 90)
    print(f"  EXP COMBINED HOLD V4 (+ w_f_pos_only=20) — Qf q1d=50 + w_f_stable=50 + w_stable_phase=30")
    ...
    name = f"stageD_combinedv4_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
