...
def main():
    print("=" * 90)
    print(f"  EXP SIMPLE PIN (state-pin only, no Qf bump no w_f_stable) (+ w_f_pos_only=20) — Qf q1d=50 + w_f_stable=50 + w_stable_phase=30")
    ...
    name = f"stageD_simplepin_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
