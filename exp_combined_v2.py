...
W_STABLE_PHASE     = 80.0   # state-pin in last 130 steps
...
def main():
    print("=" * 90)
    print(f"  EXP COMBINED HOLD V2 (stable_phase=80) — Qf q1d=50 + w_f_stable=50 + w_stable_phase=30")
    ...
    name = f"stageD_combinedv2_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
