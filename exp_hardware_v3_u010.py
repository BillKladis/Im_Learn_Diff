"""exp_hardware_v3_u010.py — Fine-tune hw_v1_ep50 with u_max=0.10 Nm torque limit.

The MAB hardware motors may be limited to 0.10 Nm in practice. This script
fine-tunes the best hw_v1 checkpoint under the tighter torque constraint to
see whether reliable swing-up and hold is achievable at 67% of the original
control authority.

Target: f01≥90% clean with u_max=0.10 Nm.
"""
...
DT     = 0.05
HORIZON = 10
U_LIM   = 0.10   # Nm — tighter than default 0.15
...
def main():
    ...
    out("=" * 80)
    out("  EXP: HARDWARE v3 — u_max=0.10 Nm fine-tune from hw_v1_ep50")
    out(f"  device: {device}")
