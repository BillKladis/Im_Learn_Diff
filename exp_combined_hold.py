...
W_STABLE_PHASE     = 30.0   # state-pin in last 130 steps
...
def main():
    print("=" * 90)
    print(f"  EXP COMBINED HOLD — Qf q1d=50 + w_f_stable=50 + w_stable_phase=30")
    ...
    name = f"stageD_combined_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
